...
try:
    disc.load_state_dict(torch.load('disc4.dat'))
...
def train(batch, i):
    ...
    if i % 100 == 0:
        torch.save(disc.state_dict(), 'disc4.dat')
...
@readme
class IterativeDecomposition6LearnableResonances(BaseExperimentRunner):
