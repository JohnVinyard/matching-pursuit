...
from modules.latent_loss import covariance, latent_loss
...
def train_model(batch):
    ...
    pl = perceptual_loss(recon, batch)
...
@readme
class TransferFunctionExperiment3(object):
    ...
    def encoded(self):
        return self.encoding.data.cpu().numpy()
